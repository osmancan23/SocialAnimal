            ...
            if (item.subject === "Kuşlar") {
              return (
                <div
                  ...
                  key={item.id}
                >
                  <div className="h-[80px] w-[80px] rounded-[50%] bg-slate-500" /> {user.photoURL ? ( <img src={user.photoURL} alt="profile"  className="h-[80px] w-[80px] rounded-[50%]"/>):(<div className="h-[80px] w-[80px] rounded-[50%] bg-slate-500" />)}        <div className="mt-5 flex flex-col">
                    <div className="flex gap-x-10">
                    <p className="font-medium">{user.displayName}</p>
                      <div className="flex gap-x-10">
                        <p className="font-medium">
