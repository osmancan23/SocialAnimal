...
const Profile = () => {
  return (
    <div>
      <Container>
        <div className="mt-[200px] flex max-w-[900px] flex-col items-center">
          <div className="flex w-full flex-row justify-between">
            ...
            <div className="flex flex-col gap-y-[100px]" >
              ...
              <button className="w-[200px] h-[40px] rounded-[30px] flex justify-center items-center text-lg bg-brand-9 text-white font-semibold">Çıkış Yap</button>
            </div>
          </div>
        </div>
      </Container>
